VERSION 5.00
Begin VB.Form FRM_FEEDBACKCALCULATOR2 
   BackColor       =   &H00FFC0FF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Feed Back Calculator (By Subject Name)"
   ClientHeight    =   3300
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   10080
   ...
   ScaleHeight     =   3300
   ScaleWidth      =   10080
   Begin VB.CommandButton CmdHelpForSubject 
      BackColor       =   &H00C0FFFF&
      Caption         =   "Help For Subject"
      BeginProperty Font 
         Name            =   "Cambria"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.ComboBox combosem 
      ...
      EndProperty
      Height          =   345
      ItemData        =   "FRM_FEEDBACKCALCULATOR2.frx":0000
      Left            =   5880
      List            =   "FRM_FEEDBACKCALCULATOR2.frx":001C
      TabIndex        =   9
      Text            =   "1"
      Top             =   1800
      Width           =   615
   ...
   Begin VB.ComboBox Combosession 
      ...
      EndProperty
      Height          =   345
      ItemData        =   "FRM_FEEDBACKCALCULATOR2.frx":0038
      Left            =   2400
      List            =   "FRM_FEEDBACKCALCULATOR2.frx":0060
      TabIndex        =   6
      Text            =   "2018-2019"
      Top             =   1800
      Width           =   2295
   ...
   End
End
Attribute VB_Name = "FRM_FEEDBACKCALCULATOR2"
...
Dim TOTEXCELLENT As Double, RCOUNT As Long, TOTOUTSTANDING As Double, TOTGOOD As Double, TOTAVERAGE As Double, TOTPOOR As Double, ACADEMICSESSION As String

Dim EMPNAME As String, SUBCODE As String, SUBNAME As String, course As String, fnd As Boolean
...
Dim sql As String
Dim SQL2 As String
sql = "SELECT * FROM EMP WHERE EMPNAME LIKE '" & Trim(Me.Combofaculty) & "' AND SUBNAME LIKE '" & Trim(Me.ComboSubname) & "' AND ACADEMICSESSION LIKE '" & Trim(Me.Combosession) & "' AND SEM LIKE '" & Trim(Me.combosem) & "'"
connect_db
...
Private Sub CmdHelpForSubject_Click()
FrmSubjectSearch2.Show
End Sub
...
Do While RS2.EOF = False
    Me.ComboSubname.AddItem RS2.Fields("SUBNAME")
    RS2.MoveNext
Loop
RS2.Close
acon.Close
